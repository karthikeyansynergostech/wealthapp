<div id="key-management-thumbnail" class="key-management-thumbnail team-slider-thumbnail owl-carousel owl-theme" data-child=".key-management">
...
<div id="key-management" class="key-management team-slider owl-carousel owl-theme" data-child=".key-management-thumbnail">
	<?php if(block_value('s1-profilepic')!=0){
	$image_attributes = wp_get_attachment_image_src($attachment_id = block_value('s1-profilepic'),"Full size");
	?>
	<div class="item"> 
