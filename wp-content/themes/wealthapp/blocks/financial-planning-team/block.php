<div id="financial-planning-team-thumbnail" class="key-management-thumbnail team-slider-thumbnail owl-carousel owl-theme" data-child=".financial-planning-team">
		...
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s1-name");?></p>
					<p class='designation'><?php echo block_value("s1-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s2-name");?></p>
					<p class='designation'><?php echo block_value("s2-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s3-name");?></p>
					<p class='designation'><?php echo block_value("s3-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s4-name");?></p>
					<p class='designation'><?php echo block_value("s4-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s5-name");?></p>
					<p class='designation'><?php echo block_value("s5-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s6-name");?></p>
					<p class='designation'><?php echo block_value("s6-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s7-name");?></p>
					<p class='designation'><?php echo block_value("s7-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s8-name");?></p>
					<p class='designation'><?php echo block_value("s8-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s9-name");?></p>
					<p class='designation'><?php echo block_value("s9-designation");?></p>
				</div>
			</div>
		</a>
	</div>
	...
	<div class="item"> 
		<a href="javascript:void(0)" class="goto" >
			<div class="item-content">
				...
				<div class="info-block">
					<p class='name'><?php echo block_value("s10-name");?></p>
					<p class='designation'><?php echo block_value("s10-designation");?></p>
				</div>
			</div>
		</a>
	</div>
...
<div id="financial-planning-team" class="key-management team-slider owl-carousel owl-theme" data-child=".financial-planning-team-thumbnail">
	<?php if(block_value('s1-profilepic')!=0){
	$image_attributes = wp_get_attachment_image_src($attachment_id = block_value('s1-profilepic'),"Full size");
	?>
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s1-name");?></p>
				<p class='designation'><?php echo block_value("s1-designation");?></p>
				<?php echo block_value("s1-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item">
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s2-name");?></p>
				<p class='designation'><?php echo block_value("s2-designation");?></p>
				<?php echo block_value("s2-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s3-name");?></p>
				<p class='designation'><?php echo block_value("s3-designation");?></p>
				<?php echo block_value("s3-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s4-name");?></p>
				<p class='designation'><?php echo block_value("s4-designation");?></p>
				<?php echo block_value("s4-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s5-name");?></p>
				<p class='designation'><?php echo block_value("s5-designation");?></p>
				<?php echo block_value("s5-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s6-name");?></p>
				<p class='designation'><?php echo block_value("s6-designation");?></p>
				<?php echo block_value("s6-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s7-name");?></p>
				<p class='designation'><?php echo block_value("s7-designation");?></p>
				<?php echo block_value("s7-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s8-name");?></p>
				<p class='designation'><?php echo block_value("s8-designation");?></p>
				<?php echo block_value("s8-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s9-name");?></p>
				<p class='designation'><?php echo block_value("s9-designation");?></p>
				<?php echo block_value("s9-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="item"> 
		<div class="item-content">
			...
			<div class="info-block">
				<p class='name'><?php echo block_value("s10-name");?></p>
				<p class='designation'><?php echo block_value("s10-designation");?></p>
				<?php echo block_value("s10-description");?>
			</div>
		</div>
	</div>
	<?php } ?>
