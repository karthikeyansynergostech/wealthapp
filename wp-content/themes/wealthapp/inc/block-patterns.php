 ...
 * @return void
 */
function wealthapp_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'wealthapp' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'wealthapp' ) ),
		'header'   => array( 'label' => __( 'Headers', 'wealthapp' ) ),
		'query'    => array( 'label' => __( 'Query', 'wealthapp' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'wealthapp' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'wealthapp_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'wealthapp_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'wealthapp/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'wealthapp_register_block_patterns', 9 );
